...
<form class="form" method="POST" action="{{ route('atualizar.produto', $findProduto->id) }}">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="mb-3">
          ...
          <input type="text" value="{{ isset($findProduto->valor) ? $findProduto->valor : old('valor')}}" id="mascara_valor" class="form-control @error('valor') is-invalid @enderror" name="valor">
          @if ($errors->has('valor'))
